...
B<(NOTE: Both bugs described below have been incorporated into Koha version
22.11.00. The changes to koha-illbackend-libris that rely on these will be
merged into the master branch some time after 22.11 is considered stabe
enough for use in production.)>
